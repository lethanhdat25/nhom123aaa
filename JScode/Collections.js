function DulieuSp(){
    ...
    for (var i=0;i<collection.length;i++) {
            g_html += "            <div class=\"item_thinh col-md-4\">\n" +
                ...
                "                    <div class=\"col-md-4\">\n" +
                "                        <a href=\"HoaDon.html?id=" + collection[i].ID_Sp + "\" style=\"text-decoration: none;color: black\"><i  class=\"fas fa-shopping-cart\"></i></a>\n" +
                "                    </div>\n" +
                "                    <div class=\"col-md-4\">\n" +
                "                        <a href=\"ChitietSp.html?id=" + collection[i].ID_Sp + "\" style=\"text-decoration: none;color: black\"><i class=\"fas fa-eye\"></i></a>\n" +
                "                    </div>\n" +
                "                    <div class=\"col-md-4\">\n" +
                ...
                "                </div>\n" +
                "                <div class=\"detail\">\n" +
                "                    <a href=\"ChitietSp.html?id=" + collection[i].ID_Sp + "\"><h5>" + collection[i].TenSP + "</h5></a>\n" +
                "                    </br>\n" +
                "                    </br>\n" +
                "                </div>\n" +
                "                <div class=\"price\">\n" +
                "                    <span><b>" + collection[i].GiaSP_HT + ".000</b></span>\n" +
                "                </div>\n" +
                "                </br>\n" +
                "                <div class=\"color\">\n" +
